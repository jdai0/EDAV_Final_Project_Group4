...
```{r, echo=FALSE, results='hide'}
unique_offense_types <- unique(data$OFNS_DESC)
...
Clusters are quite obvious to detect! Specifically, Manhattan, Brooklyn, Bronx exhibit much densely populated for arrest locations than the other two boroughs.

Careful readers may ask, why are there blank spaces for these regional directors? Good question!
...
Try to find these hidden places in the interactive plot below!

### Interactive Arrest Density Distribution
...
After we've seen the rough percentage distribution of demographics, let's then check the more detailed data next.
