...
```{r, echo=FALSE, results='hide', warning=FALSE}
# # 设置频率为每月
# time_series <- ts(daily_data$Count, start = c(2024, 1), frequency = 30)
# 
# # 分解时间序列
# library(forecast)
# decomposed <- stl(time_series, s.window = "periodic")
# 
# # 绘制分解结果
# autoplot(decomposed) +
#   labs(title = "Time Series Decomposition (Monthly Cycle)",
#        x = "Time",
#        y = "Count") +
#   theme_minimal()
