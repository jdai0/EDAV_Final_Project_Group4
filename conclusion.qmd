...
Geographic clusters are quite obvious to detect. Specifically, Manhattan, Brooklyn, Bronx exhibit densely populated arrest locations, compared to Queens and Staten Island.
...
We encountered challenges when attempting to visualize precinct-level data. The given dataset alone lacked sufficient information to effectively map precincts. To address this, we utilized the NYC Open Data API to extract additional data for more thorough analysis.
